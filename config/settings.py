...
# on ultise decouple grace a pip install python-decouple 
...
# SECRET_KEY = 'django-insecure-t1=s7oesbefysz-di@@bc6o*_mihhuf_l=r8)zb@3q#3f5%)jp'
...
# Setup pour image en prod: Cloudinary + statiques via WhiteNoise
if not DEBUG:
    CLOUDINARY_STORAGE = {
